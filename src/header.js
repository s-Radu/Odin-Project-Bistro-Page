...
export function header() {
  ...
  <img src="${logo}" alt="Bistro: Lebăda neagră" class="w-20 cursor-pointer home">
  <nav
  ...
  <div class="relative mr-4 md:hidden">
      ...
      <div
          class="flex flex-col gap2 items-center  justify-between absolute -bottom-40 w-[6.5rem] h-36 -left-4 md:hidden">
          <p
